...
public class SharedPreferencesUtil {
    ...
    public static void init(Context context,String prefname,int mode){
        preferencesUtil=new SharedPreferencesUtil();
        preferencesUtil.context=context;
        preferencesUtil.prefs=preferencesUtil.context.getSharedPreferences(prefname,mode);
        preferencesUtil.editor=preferencesUtil.prefs.edit();
    }
