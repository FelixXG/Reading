...
import com.flightmanager.reading.bean.RrecommendBookList;
...
public interface BookApiService {
    ...
    Observable<RrecommendBookList>getRecommendBookList(@Path("bookId")String bookId,@Query("limit") String limit);
