...
import com.flightmanager.reading.ReadingApplication;
...
public class LogUtils {
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + ReadingApplication.getsInstance().getPackageName();
        LOG_FILE_NAME = "Log";
    }
